...
const Dictaphone = () => {
  ...
  const getBackgroundColor = () => {
    if (!prediction || prediction.fraud_probability === undefined)
      ...
      <div className="dictaphone-card">
        ...
        <span
          className={`microphone-status ${
            listening ? "microphone-on" : "microphone-off"
          }`}
        >
        ...
        {prediction && (
          <div className={`dictaphone-transcript  ${getBackgroundColor()}`}>
            <p>
              ...
              <span className="predication-value">
                {prediction?.fraud_probability}%
              </span>
            </p>
            {prediction?.reason && (
              <p>
                ⚠️ <strong>Reason:</strong> {prediction.reason}
              </p>
            )}
          </div>
        )}
